...
class NERExample(object):
    """
    Data wrapper for a single sentence for ner classification, which consists of many individual tokens to classify.

    Attributes:
        tokens: the sentence to classify
        labels: NER label for tokens --  PER, LOC, ORG, MISC, O (five classes).
    """
